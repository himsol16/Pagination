...
{
	wp_register_script('custom-cta-js',get_template_directory_uri().'/assets/js/gutenberg-cta-block.js',array('wp-blocks'));
	register_block_type('custom/custom-cta',array(
...
{
	wp_register_script('ideapro-custom-block',get_template_directory_uri().'/assets/js/ideapro-custom.js',array('wp-blocks','wp-i18n','wp-editor'),true,false);
}

add_action( 'init', 'ideapro_custom_block_script_register' );*/


function wpdocs_theme_name_scripts() {
    

    wp_enqueue_script( 'vue-js', get_template_directory_uri() . '/assets/js/vue.js', array(), '1.0.0', true );
    wp_enqueue_script( 'vue-resource-js', get_template_directory_uri() . '/assets/js/vue-resource.js', array(), '2.0.0', true );
    wp_enqueue_script( 'vue-router-js', get_template_directory_uri() . '/assets/js/vue-router.js', array(), '3.0.0', true );
    wp_enqueue_script( 'app-js', get_template_directory_uri() . '/assets/js/app.js', array(), '4.0.0', true );
}
...
add_filter('rest_prepare_project', 'prepare_rest', 10, 3);
